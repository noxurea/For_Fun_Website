...
const themeLink = document.querySelector('link[href="Styles/lightmode.css"]') || document.querySelector('link[href="Styles/darkmode.css"]');
...
function calculate() {
    try {
        if (display.value === "12+30+04") {
            display.value = "Redirecting...";
            setTimeout(() => {
                window.location.href = "main.html"; // Replace with your desired HTML file
